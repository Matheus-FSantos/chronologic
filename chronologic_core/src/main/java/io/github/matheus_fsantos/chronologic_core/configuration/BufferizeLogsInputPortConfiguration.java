...
public class BufferizeLogsInputPortConfiguration {
    @Bean
    public BufferizeLogsInputPort bufferizeLogsUseCaseConfiguration(CachePersistLogsOutputPort cachePersistLogsOutputPort) {
        return new BufferizeLogsUseCase(cachePersistLogsOutputPort);
    }
}
